...
Users' own PCs are also workers & The pool is a symmetric co-operative, not a donated cluster \\
...
\begin{itemize}
  ...
  \item A \textbf{submit-only client} --- a fourth machine with no account on
        the entry node, no shared filesystem, and Condor's own daemons
        deliberately disabled.
\end{itemize}

Jobs submitted from the client distribute across all three machines and return
