...
Chapter~\ref{ch:security}. Step 5's second clause is not redundant with its
first: appearing in \kn{condor\_status} and accepting work are independent
properties, and Chapter~\ref{ch:failure} catalogues several ways to have the
